    ...
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          >
            <Link to="/predict" className="bg-cyan-500 hover:bg-cyan-400 text-navy-900 px-8 py-4 rounded-full font-bold text-center transition-all hover:shadow-[0_0_20px_rgba(6,182,212,0.6)] transform hover:-translate-y-1">
              Analyze My Profile
            </Link>
            <a href="#model" className="glass-panel text-white hover:bg-white/10 px-8 py-4 rounded-full font-bold text-center transition-all transform hover:-translate-y-1 border-white/20">
              Explore Model
            </a>
          </motion.div>
        </div>
